...
// Custom sub-component handling standard HTML5 Link optimizations
...
export default function Navbar() {
  ...
  // Base navigation links layout configuration
  const navLinks = [
    { label: "Home", href: "/" },
  ...
  return (
    <header className="fixed top-5 left-0 right-0 z-50 px-4">
      ...
      <div className="mx-auto container">
        <nav className="flex py-4 items-center px-6 justify-between rounded-2xl bg-[#0F1117]/10 backdrop-blur-sm border border-white/5 shadow">
