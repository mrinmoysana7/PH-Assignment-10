...
export default function FilterSelect({
  ...
  const colors = {
    violet: {
      ...
      hover: "hover:border-violet-300 hover:border",
      focus:
    ...
    sky: {
      bg: "bg-sky-100",
      text: "text-sky-600",
      hover: "hover:border-sky-300 hover:border",
      focus:
    ...
    orange: {
      ...
      hover: "hover:border-orange-300 hover:border",
      focus:
        "focus-within:border-orange-500 outline-none focus-within:ring-2 focus-within:ring-orange-500/20",
    },
    emerald: {
      bg: "bg-emerald-100",
      text: "text-emerald-600",
      hover: "hover:border-emerald-300 hover:border",
      focus:
